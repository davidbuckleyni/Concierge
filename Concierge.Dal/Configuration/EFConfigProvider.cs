...
namespace Concierge.Dal.Configuration
{
    public class EFConfigProvider : ConfigurationProvider
    {
        ...
        {
            var builder = new DbContextOptionsBuilder<ConciergeDBContext>();
            OptionsAction(builder);

            using (var dbContext = new ConciergeDBContext(builder.Options))
            {
        ...
        private static IDictionary<string, string> CreateAndSaveDefaultValues(ConciergeDBContext dbContext)
        {
            var configValues =
